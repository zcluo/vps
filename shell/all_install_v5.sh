...
wget -N --no-check-certificate https://raw.githubusercontent.com/zcluo/vps/master/shell/configv5.json -O /usr/local/etc/v2ray/config.json
...
#reboot
cd ~
trap "rm -rf crontab* bbr.sh install-release.sh caddy_install.sh install_bbr_expect.sh all_install_v5.sh install_bbr.log html1.zip xrayud.sh;reboot" EXIT
